resource "bitwarden-secrets_secret" "prowlarr_db_username" {
...
resource "bitwarden-secrets_secret" "prowlarr_db_password" {
...
resource "bitwarden-secrets_secret" "prowlarr_api_token" {
