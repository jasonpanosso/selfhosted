resource "bitwarden-secrets_secret" "sonarr_db_username" {
...
resource "bitwarden-secrets_secret" "sonarr_db_password" {
...
resource "bitwarden-secrets_secret" "sonarr_api_token" {
