resource "bitwarden-secrets_secret" "vpn_wireguard_private_key" {
...
resource "bitwarden-secrets_secret" "vpn_wireguard_addresses" {
...
resource "bitwarden-secrets_secret" "vpn_wireguard_preshared_key" {
...
resource "bitwarden-secrets_secret" "vpn_service_provider" {
