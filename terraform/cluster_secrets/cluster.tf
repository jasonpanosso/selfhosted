resource "bitwarden-secrets_secret" "cluster_id" {
  key        = "CLUSTER_ID"
...
resource "bitwarden-secrets_secret" "cluster_secret" {
  key        = "CLUSTER_SECRET"
...
resource "bitwarden-secrets_secret" "cluster_token" {
  key        = "CLUSTER_TOKEN"
...
resource "bitwarden-secrets_secret" "cluster_ca_crt" {
  key        = "CLUSTER_CA_CRT"
...
resource "bitwarden-secrets_secret" "cluster_ca_key" {
  key        = "CLUSTER_CA_KEY"
...
resource "bitwarden-secrets_secret" "cluster_aggregator_ca_crt" {
...
resource "bitwarden-secrets_secret" "cluster_aggregator_ca_key" {
...
resource "bitwarden-secrets_secret" "cluster_secretbox_encryption_secret" {
...
resource "bitwarden-secrets_secret" "cluster_service_account_key" {
